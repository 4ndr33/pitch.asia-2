              ...
              <?php if( have_posts() ) : ?>
                    ...
                    <div class="archive-meta-container">
                         <div class="archive-head">
                              <h1><?php printf(__('<font color=red>%s</font>','profound'),single_cat_title( '', false )); ?></h1>
                         </div>
                              ...
                              <?php
                                $profound_category_description = term_description();
                                    if ( ! empty( $profound_category_description ) ) {
                                        ...
                                        printf(__('News in the <font color=red>%s</font> category.','profound'),single_cat_title( '', false ));
                                    }
                              ?>
                         </div>
